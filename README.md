...
**Training is a few lines** — `~` makes a trainable variable, an optimizer (`adam`, `adamw`, `sgd`, `adagrad`) minimizes a loss thunk, `⟳` runs it between frames so the UI stays live:
...
[▶&nbsp;run](https://mlajtos.github.io/fluent/?code=zrg6IH4oWzAsIDBdKSwK8J2TmzogeyDOoygozrggLSBbMC4yMywgMC40N10pXjIpIH0sCm9wdDogYWRhbSgwLjEpLAp7IG9wdCjwnZObKSB9IOKfsyAxMDAsCs64)
